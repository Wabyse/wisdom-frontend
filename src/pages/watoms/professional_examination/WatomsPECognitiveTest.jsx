        ...
        <>
            ...
            <div className="w-full h-[88vh] flex bg-[#0a183d]">
                ...
                <div className="w-[10%] bg-white/55 flex flex-col justify-evenly items-center">
                    ...
                    <div className="w-[90%] h-[12%] flex flex-col justify-center items-center text-yellow-400  text-sm text-center bg-gray-500 px-2 rounded-xl border-blue-600 border-2">اختبار القدرات المعرفية الاساسية<p>CAT</p></div>
                </div>
                        ...
                        <div className="w-full flex flex-col text-white">
                            ...
                            <div className="w-full my-4 flex justify-center gap-2">
                                ...
                                <div className="text-yellow-400 font-bold underline text-center">
                                    اختبار قدرات المعرفية الاساسية
                                </div>
                            </div>
                            {/* test score */}
                            <div className="w-full flex flex-col gap-2">
                                ...
                                <div className="w-full h-[43vh] flex flex-col gap-2 overflow-y-scroll font-bold">
                                    <div className="w-full flex justify-center gap-2">
                                        ...
                                        <div className="w-[60%] flex justify-center items-center border-white border-2 rounded-xl py-2">كل (أ) هم (ب) بعض (ب) هم (ج) هل بالضرورة بعض (أ) هم (ج)؟</div>
                                    ...
                                    <div className="w-full flex justify-center gap-2">
                                        ...
                                        >
                                            ...
                                            {["دقيق", "مهمل", "حريص", "منضبط"].map((value) => {
                                                return (
                                                    <option key={value} value={value} className="text-black">
                                                        {value}
                                                    </option>
                                        ...
                                        <div className="w-[60%] flex justify-center items-center border-white border-2 rounded-xl py-2">ما هي الكلمة التي لا تتناسب مع المجموعة ؟ دقيق, مهمل, حريص, منضبط</div>
...
export default WatomsPECognitiveTest;