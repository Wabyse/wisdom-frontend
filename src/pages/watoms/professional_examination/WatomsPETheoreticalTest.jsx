        ...
        <>
            ...
            <div className="w-full h-[88vh] flex bg-[#0a183d]">
                ...
                <div className="w-[10%] bg-white/55 flex flex-col justify-evenly items-center">
                    ...
                    <div className="w-[90%] h-[12%] flex flex-col justify-center items-center text-yellow-400  text-sm text-center bg-gray-500 px-2 rounded-xl border-blue-600 border-2">اختبار المعارف الفنية المتخصص <p>JCT</p></div>
                            ...
                            <div className="w-full flex flex-col gap-2">
                                ...
                                <div className="w-full h-[43vh] flex flex-col gap-2 overflow-y-scroll font-bold">
                                    ...
                                    <div className="w-full flex justify-center gap-2">
                                        ...
                                        <div className="w-[60%] flex justify-center items-center border-white border-2 rounded-xl py-2">مدي التزام المراقب بعدم التدخل مع المتقدم أثناء الاختبار النظري</div>
                                    ...
                                    <div className="w-full flex justify-center gap-2">
                                        ...
                                        <div className="w-[60%] flex justify-center items-center border-white border-2 rounded-xl py-2">مدي رضاء المتقدم عن الاختبار النظري</div>
                                    ...
                                    <div className="w-full flex justify-center gap-2">
                                        ...
                                        <div className="w-[60%] flex justify-center items-center border-white border-2 rounded-xl py-2">مدي رضاء المتقدم عن تفهم التلقين قبل بدء الاختبار النظري</div>
                                    ...
                                    <div className="w-full flex justify-center gap-2">
                                        ...
                                        <div className="w-[60%] flex justify-center items-center border-white border-2 rounded-xl py-2">مدي رضاء المتقدم عن توفر وجاهزية الأجهزة والمعدات الأزمة للاختبار النظري</div>
                                    ...
                                    <div className="w-full flex justify-center gap-2">
                                        ...
                                        <div className="w-[60%] flex justify-center items-center border-white border-2 bg-transparent rounded-xl py-2">تقييم المراقب للجودة عن عملية الاختبار النظري</div>
...
export default WatomsPETheoreticalTest;