...
const WatomsPEDashboard = () => {
    ...
    const data6 = [
        { id: 5, name: "OCEAN", performance: 100 },
        { id: 4, name: "CAT", performance: 80 },
        { id: 2, name: "SJT", performance: 70 },
        { id: 1, name: "JCT", performance: 60 },
        { id: 3, name: "IVF", performance: 55 },
        { id: 6, name: "PST", performance: 20 },
    ];
