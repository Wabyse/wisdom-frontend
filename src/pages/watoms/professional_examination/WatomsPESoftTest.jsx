        ...
        <>
            ...
            <div className="w-full h-[88vh] flex bg-[#0a183d]">
                ...
                <div className="w-[10%] bg-white/55 flex flex-col justify-evenly items-center">
                    ...
                    <div className="w-[90%] h-[12%] flex flex-col justify-center items-center text-yellow-400  text-sm text-center bg-gray-500 px-2 rounded-xl border-blue-600 border-2">اختبار المهارات الوظيفية الناعمة<p>SJT</p></div>
                        ...
                        <div className="w-full flex flex-col text-white">
                            ...
                            <div className="w-full my-4 flex justify-center gap-2">
                                ...
                                <div className="text-yellow-400 font-bold underline text-center">
                                    اختبار المهارات الوظيفية الناعمة
                                </div>
                            </div>
                            {/* test score */}
...
export default WatomsPESoftTest;