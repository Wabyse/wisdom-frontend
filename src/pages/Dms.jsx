              ...
              <>
                <div className="space-y-4">
                  <h3 className="text-xl font-bold text-gray-900 flex items-center gap-2">
                    ...
                    {language ? "School Selection" : "اختيار المدرسة"}
                  </h3>
                  <select
                  ...
                  >
                    <option value="">{language ? "Select School" : "اختر المدرسة"}</option>
                    {schools?.map((school) => (
  ...
  useEffect(() => {
    const fetchingOrg = async () => {
      try {
        ...
        const filteredSchools = response.filter(school => school.id === 1 || school.id === 2 || school.id === 6 || school.id === 11 || school.id === 12);
