                ...
                <div className={`md:flex ${mobile ? "hidden" : ""} justify-between`}>
                    <div className="flex flex-col">
                        <div className={`text-black text-[18px] m-5 ${description ? "" : "hidden"}`}>
                            <span className="opacity-75 flex flex-col md:gap-12 gap-4 h-[50vh] md:w-[400px] w-[360px] bg-white shadow-lg shadow-black/30 px-3 py-3 rounded">
                                ...
                                <p className="w-[90%] md:text-base text-[15px]">{description}</p>
                            </span>
                        </div>
                    ...
                    >
                        <div className={`w-full h-full p-2 transition-all duration-1000 ease-in-out ${sideBar ? "overflow-hidden" : "overflow-visible min-w-[225px]"}`}>
